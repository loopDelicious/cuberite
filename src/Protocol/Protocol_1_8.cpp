...
void cProtocol_1_8_0::SendSpawnEntity(const cEntity & a_Entity)
{
	...
	else if (a_Entity.IsProjectile())
	{
		...
		if (Projectile.GetProjectileKind() == cProjectileEntity::eKind::pkArrow)
		{
	...
	SendSpawnEntity(a_Entity, EntityType, EntityData);
}
...
void cProtocol_1_8_0::SendSpawnEntity(const cEntity & a_Entity, const UInt8 a_ObjectType, const Int32 a_ObjectData)
{
	ASSERT(m_State == 3);  // In game mode?
	...
	switch (a_Entity.GetEntityType())
	{
		...
		case Type::etProjectile:
		{
			...
			switch (Projectile.GetProjectileKind())
			{
				...
				default: UNREACHABLE("Spawned an unhandled projectile");
			}
		}
		case Type::etFloater: return 90;
		case Type::etItemFrame: return 71;
		case Type::etLeashKnot: return 77;
		default: UNREACHABLE("Spawned an unhandled entity");
	}
}
